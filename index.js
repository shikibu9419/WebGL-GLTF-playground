...
//   console.log(width + ", " + height);
  ...
  const orbitControls = new THREE.FirstPersonControls(camera, renderer.domElement)
    ...
    function (gltf) {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const textures = [
          ...
          'textures/wing_diffuse.png',
          'textures/eyes_specularGlossiness.png',
          'textures/feather_specularGlossiness.png',
          'textures/material_specularGlossiness.png',
          'textures/peck_specularGlossiness.png',
          'textures/tongue_specularGlossiness.png',
          'textures/wing_specularGlossiness.png'
        ].map(s => {
